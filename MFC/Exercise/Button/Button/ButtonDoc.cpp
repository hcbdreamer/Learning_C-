...
// 缩略图的支持
void CButtonDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CButtonDoc::InitializeSearchContent()
{
...
void CButtonDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
